...
```typescript
import type { CreatePracticeResponse } from "@affinity-health/sdk";
...
const example = {
  ...
  supportPhone: null,
  timezone: null,
} satisfies CreatePracticeResponse;
...
const exampleParsed = JSON.parse(exampleJSON) as CreatePracticeResponse;
