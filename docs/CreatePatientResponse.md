...
```typescript
import type { CreatePatientResponse } from "@affinity-health/sdk";
...
const example = {
  ...
  status: null,
  updatedAt: null,
} satisfies CreatePatientResponse;
...
const exampleParsed = JSON.parse(exampleJSON) as CreatePatientResponse;
