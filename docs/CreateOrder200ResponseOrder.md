...
```typescript
import type { CreateOrder200ResponseOrder } from '@affinity-health/sdk'
...
const example = {
  ...
  "trackingNumber": null,
  "updatedAt": null,
} satisfies CreateOrder200ResponseOrder
...
const exampleParsed = JSON.parse(exampleJSON) as CreateOrder200ResponseOrder
