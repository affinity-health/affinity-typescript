...
```typescript
import type { UpdatePatientResponse } from "@affinity-health/sdk";
...
const example = {
  ...
  status: null,
  updatedAt: null,
} satisfies UpdatePatientResponse;
...
const exampleParsed = JSON.parse(exampleJSON) as UpdatePatientResponse;
