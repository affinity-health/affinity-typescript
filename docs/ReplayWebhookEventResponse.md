...
```typescript
import type { ReplayWebhookEventResponse } from "@affinity-health/sdk";
...
const example = {
  ...
  deliveries: null,
  payload: null,
} satisfies ReplayWebhookEventResponse;
...
const exampleParsed = JSON.parse(exampleJSON) as ReplayWebhookEventResponse;
